...
namespace Chomp
{
	...
	public abstract class GameCharacter
	{
		...
		public virtual void Move()
		{
			...
			if (_attemptedDirection != CharacterDirection.FrozenInvincible && _board.CanMove(GetNextCoordinate(_attemptedDirection, _currentLocation)))
			{
				...
				_attemptedDirection = CharacterDirection.FrozenInvincible;
		...
		protected virtual void MoveToEndPoint(CharacterDirection Direction, Point p)
		{
			...
			{
				if (_attemptedDirection != CharacterDirection.FrozenInvincible)
				{
