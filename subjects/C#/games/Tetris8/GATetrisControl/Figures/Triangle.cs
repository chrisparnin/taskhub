...
namespace GATetrisControl
{
	internal class Triangle : Figure
	{
		...
		public Triangle(TetrisGrid tg) : base(tg)
		{
			yPosition = 0;
			xPosition = (columns - 1) / 2;
			color = parent.settings.triangleColor;
		}
		...
		internal override void DrawPreview(Graphics g)
		{
			...
			Rectangle r1 = new Rectangle((5 * a)/2,a * 2,a,a);
			Rectangle r2 = new Rectangle((3 * a)/2,a * 3,a,a);
			Rectangle r3 = new Rectangle((3 * a)/2 + a,a * 3,a,a);
			Rectangle r4 = new Rectangle((3 * a)/2 + 2 * a,a * 3,a,a);
